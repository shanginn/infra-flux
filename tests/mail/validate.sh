...
grep -q '"object":"MtaOutboundStrategy"' "$tmpdir/work/plan.ndjson"
grep -q '"if":"is_local_domain(rcpt_domain)","then":"'"'"'local'"'"'"' "$tmpdir/work/plan.ndjson"
grep -q '"else":"'"'"'mx'"'"'"' "$tmpdir/work/plan.ndjson"
